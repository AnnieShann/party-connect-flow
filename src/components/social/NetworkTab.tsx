              ...
              {selecting ? (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ borderColor: vibeColors[c.vibe] }}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground font-mono">
                      {c.sharedQuests} shared quest{c.sharedQuests !== 1 ? 's' : ''}
                    </p>
                  </div>
                </button>
              ) : (
          ...
          {selecting && (
            ...
            >
              <button
                ...
                className="flex-1 py-3 rounded-full border border-border text-sm font-semibold text-muted-foreground active:scale-95 transition-transform"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 py-3 rounded-full bg-primary text-primary-foreground text-sm font-bold flex items-center justify-center gap-2 active:scale-95 transition-transform disabled:opacity-40"
              >
